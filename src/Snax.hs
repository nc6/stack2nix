...
run O.Init{..} = do
  ...
  withFile (SL.libPath </> "default.nix") WriteMode $ \h -> do
    hPutStrLn h "# Generated by snax"
    hPrint h $ SL.libNix _stackYaml _bootstrap

  withFile "default.nix" WriteMode $ \h -> do
    hPutStrLn h "# Generated by snax"
    hPrint h (SL.defaultNix $ fromMaybe "<nixpkgs>" _nixpkgsRepository)
